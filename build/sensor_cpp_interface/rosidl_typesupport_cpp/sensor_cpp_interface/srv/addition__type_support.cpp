...
static const _Addition_Request_type_support_symbol_names_t _Addition_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_cpp_interface, srv, Addition_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_cpp_interface, srv, Addition_Request)),
  }
};
...
{
  return &::sensor_cpp_interface::srv::rosidl_typesupport_cpp::Addition_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor_cpp_interface, srv, Addition_Request)() {
  return get_message_type_support_handle<sensor_cpp_interface::srv::Addition_Request>();
}
...
static const _Addition_Response_type_support_symbol_names_t _Addition_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_cpp_interface, srv, Addition_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_cpp_interface, srv, Addition_Response)),
  }
};
...
{
  return &::sensor_cpp_interface::srv::rosidl_typesupport_cpp::Addition_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensor_cpp_interface, srv, Addition_Response)() {
  return get_message_type_support_handle<sensor_cpp_interface::srv::Addition_Response>();
}
...
static const _Addition_type_support_symbol_names_t _Addition_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensor_cpp_interface, srv, Addition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensor_cpp_interface, srv, Addition)),
  }
};
...
{
  return &::sensor_cpp_interface::srv::rosidl_typesupport_cpp::Addition_service_type_support_handle;
}
