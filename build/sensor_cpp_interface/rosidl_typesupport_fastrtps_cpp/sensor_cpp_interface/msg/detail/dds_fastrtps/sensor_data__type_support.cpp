...
#include "sensor_cpp_interface/msg/detail/sensor_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensor_cpp_interface::msg::SensorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensor_cpp_interface::msg::SensorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensor_cpp_interface::msg::SensorData *>(
    untyped_ros_message);
...
{
  return &sensor_cpp_interface::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
