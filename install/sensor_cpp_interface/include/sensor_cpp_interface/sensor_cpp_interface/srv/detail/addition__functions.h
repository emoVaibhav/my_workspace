...
#ifndef SENSOR_CPP_INTERFACE__SRV__DETAIL__ADDITION__FUNCTIONS_H_
#define SENSOR_CPP_INTERFACE__SRV__DETAIL__ADDITION__FUNCTIONS_H_
...
/// Initialize srv/Addition message.
/**
...
/// Create srv/Addition message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sensor_cpp_interface__srv__Addition_Request__init().
...
/// Destroy srv/Addition message.
/**
 * It calls
 * sensor_cpp_interface__srv__Addition_Request__fini()
...
/// Check for srv/Addition message equality.
/**
...
/// Initialize array of srv/Addition messages.
/**
...
/// Finalize array of srv/Addition messages.
/**
 * It calls
 * sensor_cpp_interface__srv__Addition_Request__fini()
...
/// Create array of srv/Addition messages.
/**
 * It allocates the memory for the array and calls
 * sensor_cpp_interface__srv__Addition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Addition messages.
/**
 * It calls
 * sensor_cpp_interface__srv__Addition_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Addition message array equality.
/**
...
/// Copy an array of srv/Addition messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sensor_cpp_interface__srv__Addition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_cpp_interface
...
/**
 * It calls
 * sensor_cpp_interface__srv__Addition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_cpp_interface
...
/**
 * It allocates the memory for the array and calls
 * sensor_cpp_interface__srv__Addition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sensor_cpp_interface
...
/**
 * It calls
 * sensor_cpp_interface__srv__Addition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SENSOR_CPP_INTERFACE__SRV__DETAIL__ADDITION__FUNCTIONS_H_
